  ...
  internal class Initializer
  {
    ...
    private Func<Materiau[], Forme>[] FormeCreators
    {
      get => new Func<Materiau[], Forme>[]
      {
        ...
        {
          Centre = new Point(Random.Next(100), Random.Next(100), Random.Next(100)),
        ...
        {
          Point1 = new Point(Random.Next(100), Random.Next(100), Random.Next(100)),
          Point2 = new Point(Random.Next(100), Random.Next(100), Random.Next(100)),
