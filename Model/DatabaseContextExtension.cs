...
namespace Hymperia.Model
{
  public static class DatabaseContextExtension
  {
    ...
    public static void LoadFormes(this DatabaseContext context, Projet projet) =>
    ...
    public static async Task LoadFormesAsync(this DatabaseContext context, Projet projet) =>
      await context.Entry(projet).Collection(p => p._Formes)
        .Query().Include(forme => forme.Materiau).LoadAsync();

    /// <summary>Load asynchronement les formes du <paramref name="projet"/>.</summary>
    public static async Task LoadFormesAsync(this DatabaseContext context, Projet projet, [NotNull] CancellationToken token = default) =>
      await context.Entry(projet).Collection(p => p._Formes)
